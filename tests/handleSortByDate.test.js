...
test('Testing Already Sorted List', () => {
  const listSorted = handleSortByDate(eventsSorted)
...
test('Testing Unsorted List With Different Dates and Times', () => {
  const listDifferentDateTime = handleSortByDate(eventsDifferentDateTime)
...
test('Testing Events With Same Dates And Times', () => {
  const listSameDateTime = handleSortByDate(eventsSameDateTime)
...
test('Testing Events With Same Dates But Different Times', () => {
  const listDifferentTime = handleSortByDate(eventsDifferentTime)
...
test('Testing Events With Same Time But Different Date', () => {
  const listDifferentDate = handleSortByDate(eventsDifferentDate)
